...
class pronto_flickr extends WP_Widget {
	
	function pronto_flickr() {
		...
		// register the widget
		$this->WP_Widget('pronto_flickr', __('Flickr'), $widget_ops);
...
add_action('widgets_init', create_function('', 'return register_widget("pronto_flickr");'));	
?>