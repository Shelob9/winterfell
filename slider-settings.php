<?php
add_action( 'admin_menu', 'home_slider_settings' );
function home_slider_settings() {
	add_theme_page( 'Home Page Slider Settings', 'Home Page Slider', 'administrator', 'home_slider_options', 'slider_options' );
}
